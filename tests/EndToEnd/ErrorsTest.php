...
final class ErrorsTest extends TestCase
{
    public function testWrongArgument():void {
        $result = ConfigurationFactory::getSchemaExecutor()->executeSchema(queryString: QueryExample::WrongArguments->value, variables: null);
    ...
    public function testWrongField():void {
        $result = ConfigurationFactory::getSchemaExecutor()->executeSchema(queryString: QueryExample::WrongProductFields->value, variables: null);
    ...
    public function testWrongVariables():void {
        $result = ConfigurationFactory::getSchemaExecutor()->executeSchema(queryString: QueryExample::ProductSearchString->value, variables: null);
        self::assertEquals('Variable "$search" of required type "String!" was not provided.', $result->errors[0]->getMessage());
        $result = ConfigurationFactory::getSchemaExecutor()->executeSchema(queryString: QueryExample::ProductSearchString->value, variables: [
